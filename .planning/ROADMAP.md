...
Plans:
- [ ] 05-01-PLAN.md — TDD: Zod schemas, auth.ts config (creatorRole + sendInvitationEmail), proxy.ts update, Server Actions
- [ ] 05-02-PLAN.md — Org switcher popover, create org dialog, wire into sidebar and layout
