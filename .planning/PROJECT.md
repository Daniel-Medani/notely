...
- [ ] Trash / soft deletes with recovery
...
- [ ] Tenant isolation via shared DB with row-level scoping (organizationId on every table)
...
- [ ] CI/CD pipeline (ESLint, Prettier, TypeScript check, Vitest, Playwright) on every PR
